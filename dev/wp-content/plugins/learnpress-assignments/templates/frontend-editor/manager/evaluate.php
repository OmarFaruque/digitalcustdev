...
<div class="wrap" id="learn-press-evaluate-front">
    <div id="evaluate-form-lpa-header">
        ...
        <h4 class="lpa-sub-page-title"><a href="<?php echo esc_attr( $man_page . '?assignment_id=' . $assignment_id ) ?>"><?php _e( 'Back to list students', 'learnpress-assignments' ); ?></a></h4>
    </div>
				...
				<div id="postbox-container-2" class="postbox-container">
					<div class="inside">
						...
						<h3 class="assignment-title">
							<a href="<?php esc_attr_e( $course_edit_url . '/' . $assignment_id ); ?>"
                            ...
                            <div id="minor-publishing">
                                <div id="major-publishing-actions">
                                    ...
                                    <input name="action" type="submit"
                                           class="button button-large evaluate"
