...
<div id="post-<?php the_ID(); ?>" <?php post_class( $class ); ?>>
    ...
    <div class="course-item">
        ...
        <div class="thim-course-content omar">
            ...
            <div class="course-meta">
                ...
                <div class="course-students om1">
                    ...
                    <span><i class="fa fa-calendar"></i></span><span style="margin-left: 10px;"><?php echo "<span>    </span>".get_the_date( 'F j, Y, g:i a', strtotime( $start_time ) ); ?></span>
                ...
                <div class="course-progress col-md-6 pull-right">
                            <div class="lp-course-progress" data-value="0" data-passing-condition="80%">
                                <label class="lp-course-progress-heading">Passing Grade :
            ...
            <div class="pull-right"><a style="margin-right: 50px;" href="<?php echo $course->get_permalink();?> "><button>Goto Webinar</button></a></div>
            <?php } ?>
                </div>
            ...
            <div class="course-readmore om8">
				...
				<?php } ?>
                <a href="<?php print wp_nonce_url('?hello=true', '', 'my_nonce'); ?>"><i class="fa fa-clone"></i></a>
            </div>
