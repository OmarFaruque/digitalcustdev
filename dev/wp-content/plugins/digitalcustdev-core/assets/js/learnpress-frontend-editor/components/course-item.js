;(function ($) {
    ...
    Vue.component('e-course-item', {
        ...
        methods: $.extend({}, FE_Base.Store_Methods, {
            ...
            _addNewLesson: function (e) {
                e.preventDefault();
                var item_title = this.$('.item-title').val();
                if (item_title.length > 0) {
                    var itemName = item_title;
                    if (itemName) {
            ...
            onPressTitle: function (e, keyboard) {
                ...
                var title_length = e.target.value.length + 1;
                //BackPress
                if (keyboard.code === 8) {
                ...
                if (title_length > 3) {
                    $(e.srcElement).closest('.e-section-item').find('.item-lesson-add-btn').show();
                } else {
                    $(e.srcElement).closest('.e-section-item').find('.item-lesson-add-btn').hide();
                    return false;
                }
            ...
            _clone: function (e) {
                ...
                var item_id = this.$el.dataset.id;
                var item_title = this.$('.item-title').val();
                if (item_id) {
                    this.$parent.cloneItem(99999, {
                        title: item_title,
                        item_id: item_id,
                        type: this.item.type
                    });
