...
$option_enforce_login      = isset( $zoom_map_array[ $meeting_info->id ]['enforce_login'] ) ? 'checked' : false;
...
$option   = 'zoom_password_meeting_' . $meeting_info->id;
...
<div class="wrap">
	...
	<?php if ( $meeting_info->id ) : ?>
		...
		<?php echo '<h4>[zoom_api_link meeting_id="' . esc_attr( $meeting_info->id ) . '" class="zoom-meeting-window" id="zoom-meeting-window" title="Your Page Title"]</h4>'; ?></div>
	<?php endif; ?>
