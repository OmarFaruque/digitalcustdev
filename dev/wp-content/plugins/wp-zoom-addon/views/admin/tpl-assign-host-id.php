<?php if ( ! defined( 'ABSPATH' ) ) {
	exit;} ?>
<div class="wrap">
	<h1><?php _e( 'Assign Host ID', 'video-conferencing-with-zoom-api' ); ?></h1>
	<div id="message" class="notice notice-warning">
		<p class="description"><strong>This section allows you to assign "Zoom" host ID to your users from WordPress !!!</strong></p>
		<p>Copy <strong>HOST ID</strong> from <a href="<?php echo admin_url( 'admin.php?page=zoom-video-conferencing-list-users' ); ?>">users</a> page, then paste it into HOST ID for any users below, to assign this system users to users in zoom system. Please contact developer if this feature is confusing to you.</p>
				...
				$users = get_users(
					array(
						...
						'role__in' => apply_filters(
							'zvc_allow_zoom_host_id_user_role',
							array( 'subscriber', 'administrator', 'contributor' )
						),
					)
				);
