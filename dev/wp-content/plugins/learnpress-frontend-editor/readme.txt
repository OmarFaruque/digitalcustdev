=== LearnPress - Frontend Course Editor ===
Contributors: thimpress, tunnhn
Donate link: http://thimpress.com/learnpress
Tags: learnpress, lms, elearning, quiz, quizzes, question, question type, courses, course, frontend, editor
...
Frontend Course Editor for LearnPress WordPress LMS Plugin.
...
== Changelog ==
= 3.0.7 =
+ Updated in order to work compatibly with LP 3.2.6.2+

= 3.0.6 =
+ Removed option which should be seen by admin in Edit Profile page of BBPress.

= 3.0.5 =
+ Fixed bug of not appearing Fill In Blank type question when not active Sorting Choice add-on.
+ Edited htaccess file.

= 3.0.4 =
+ Fixed lost dashicons and some styles when using with Yoast SEO plugin.

= 3.0.3 =
+ Updated language file.

= 3.0.2.5 =
+ Integrated with Coming Soon addon.
+ Allow translating the plural texts of "min, hour, day, week".

= 3.0.2.4 =
+ Added languages.

= 3.0.2.3 =
~ Added 'draft' status for course.
~ Fixed issue with course forum/certificate.
~ Fixed 'Invalid post ID' message when changing the title of an empty item.
~ Fixed js tooltip for course assessment.

= 3.0.2.2 =
+ Added shortcode to add to page.
~ Fixed section name not update when it changes.
~ Fixed conflict with some other plugins.
~ Fixed load assets only in frontend editor page.

= 3.0.2.1 =
~ Fixed js code to ensure jQuery loaded.
+ Added link to back to home page.

= 3.0.2 =
~ Fixed js code conflict with other plugins.

= 3.0.1 =
+ Fixed fatal error message when calling admin template in frontend end
