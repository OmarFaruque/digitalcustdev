...
if ( $the_query->have_posts() ) :
	...
	if ( $view_all_course ) {
		echo '<a class="view-all-courses" href="' . get_post_type_archive_link( 'lpr_course' ) . '">' . esc_attr( $view_all_course ) . '</a>';
	}
	?>
					...
					<div class="thim-course-content">
						...
						<div class="course-meta">
							<div class="course-student">
								...
								?>
								<div class="value"><i class="fa fa-group"></i><?php echo esc_attr( $student ); ?>
								</div>
							</div>
