<?php
/**
 * Class LP_Email_Webinar_Notification_Ten_Admin
 *
 * @author   ThimPress
...
if ( ! class_exists( 'LP_Email_Webinar_Notification_Ten_Admin' ) ) {
	/**
	 * Class LP_Email_Webinar_Notification_Ten_Admin.
	 */
	class LP_Email_Webinar_Notification_Ten_Admin extends LP_Email {
		...
		public function __construct() {
			...
			$this->id          = 'webinar-notification-ten-admin';
			...
			add_action( 'learn-press/zoom-notification-lession-ten-admin', array( $this, 'trigger' ), 99, 2 );
		}
...
return new LP_Email_Webinar_Notification_Ten_Admin();