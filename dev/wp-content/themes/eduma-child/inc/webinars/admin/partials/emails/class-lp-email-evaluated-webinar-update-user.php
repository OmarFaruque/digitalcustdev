<?php
/**
 * Class LP_Email_Webinar_Update_Evaluated_User
 *
 * @author   ThimPress
...
if ( ! class_exists( 'LP_Email_Webinar_Update_Evaluated_User' ) ) {
	/**
	 * Class LP_Email_Webinar_Update_Evaluated_User.
	 */
	class LP_Email_Webinar_Update_Evaluated_User extends LP_Email {
		...
		public function __construct() {
			...
			$this->id          = 'webinar-update-user';
			$this->title       = __( 'User', 'learnpress-assignments' );
			$this->description = __( 'Send this email to user when teacher have update webinar lesson on zoom.', 'learnpress-assignments' );
...
return new LP_Email_Webinar_Update_Evaluated_User();