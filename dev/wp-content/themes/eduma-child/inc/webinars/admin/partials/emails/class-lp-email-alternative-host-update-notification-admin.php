<?php
/**
 * Class LP_Email_Update_Alternative_Host_Notification_Admin
 *
 * @author   ThimPress
...
if ( ! class_exists( 'LP_Email_Update_Alternative_Host_Notification_Admin' ) ) {
	/**
	 * Class LP_Email_Update_Alternative_Host_Notification_Admin.
	 */
	class LP_Email_Update_Alternative_Host_Notification_Admin extends LP_Email {
		...
		public function __construct() {
			...
			$this->id          = 'updatehost-notification-admin';
			...
			add_action( 'zoom/zoom-notification-update-alternative-host-admin', array( $this, 'trigger' ), 99, 2 );
		}
...
return new LP_Email_Update_Alternative_Host_Notification_Admin();