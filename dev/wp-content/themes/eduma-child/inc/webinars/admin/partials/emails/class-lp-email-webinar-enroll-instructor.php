<?php
/**
 * LP_Email_Enrolled_Webinar_Instructor.
 *
 * @author  ThimPress
...
if ( ! class_exists( 'LP_Email_Enrolled_Webinar_Instructor' ) ) {

	/**
	 * Class LP_Email_Enrolled_Webinar_Instructor
	 */
	class LP_Email_Enrolled_Webinar_Instructor extends LP_Email_Type_Enrolled_Course {
		/**
		 * LP_Email_Enrolled_Webinar_Instructor constructor.
		 */
		public function __construct() {
			$this->id          = 'enrolled-webinar-instructor';
...
return new LP_Email_Enrolled_Webinar_Instructor();