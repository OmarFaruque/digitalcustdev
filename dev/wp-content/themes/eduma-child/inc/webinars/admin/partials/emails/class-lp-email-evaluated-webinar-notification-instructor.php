<?php
/**
 * Class LP_Email_Webinar_Notification_Evaluated_Instructor
 *
 * @author   ThimPress
...
if ( ! class_exists( 'LP_Email_Webinar_Notification_Evaluated_Instructor' ) ) {
	/**
	 * Class LP_Email_Webinar_Notification_Evaluated_Instructor.
	 */
	class LP_Email_Webinar_Notification_Evaluated_Instructor extends LP_Email {
		...
		public function __construct() {
			...
			$this->id          = 'webinar-notification-instructor';
...
return new LP_Email_Webinar_Notification_Evaluated_Instructor();