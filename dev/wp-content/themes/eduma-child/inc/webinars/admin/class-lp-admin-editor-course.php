...
/**
 * Class LP_Admind_Editor_Course
 *
 * @since 3.0.2
 */
class LP_Admin_Editor_Course_THEME extends LP_Admin_Editor {
	...
	public function dispatch() {
		...
		$this->section_curd = new LP_Section_CURD_THEME( $course_id );
	 ...
	 * @return array|bool
	 */
	public function new_section_item_test( $args = array() ) {
		$section_id = ! empty( $args['section_id'] ) ? $args['section_id'] : false;
		$item       = ! empty( $args['item'] ) ? $args['item'] : false;
		$item       = json_decode( wp_unslash( $item ), true );
