...
if ( $the_query->have_posts() ) :
	...
	if ( $view_all_course && 'top' == $view_all_position ) {
		echo '<a class="view-all-courses position-top" href="' . get_the_permalink( learn_press_get_page_id( 'webinar' ) ) . '">' . esc_attr( $view_all_course ) . ' <i class="lnr icon-arrow-right"></i></a>';
	}
	?>
	<div class="thim-course-grid">
		...
		// echo '<pre>';
		// print_r(get_post_meta($course_id));
		// echo '</pre>';
	...
	if ( $view_all_course && 'bottom' == $view_all_position ) {
		echo '<a class="view-all-courses position-bottom" href="' . get_the_permalink( learn_press_get_page_id( 'webinar' ) ) . '">' . esc_attr( $view_all_course ) . ' <i class="lnr icon-arrow-right"></i></a>';
	}
	echo '</div>';
