...
if ( $the_query->have_posts() ) :
	?>
	<div class="thim-widget-courses-wrapper 6">
		<?php
		if ( $instance['title'] ) {
			echo ent2ncr( $args['before_title'] . $instance['title'] . $args['after_title'] );
		}
		if ( $view_all_course && 'top' == $view_all_position ) {
			echo '<a class="view-all-courses position-top" href="' . get_the_permalink( learn_press_get_page_id( 'webinar' ) ) . '">' . esc_attr( $view_all_course ) . '</a>';
		}
		?>
			...
			?>
				<div class="lpr_course <?php echo 'course-grid-' . $columns; ?>">
					<div class="course-item">
						<div class="course-thumbnail omr1">
		...
		if ( $view_all_course && 'bottom' == $view_all_position ) {
			echo '<a class="view-all-courses position-bottom" href="' . get_the_permalink( learn_press_get_page_id( 'webinar' ) ) . '">' . esc_attr( $view_all_course ) . '</a>';
		}
		?>
	</div>
	<div class="clear"></div>
