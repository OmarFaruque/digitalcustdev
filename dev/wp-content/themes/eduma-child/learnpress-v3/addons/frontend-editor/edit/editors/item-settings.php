...
?>
 <script type="text/x-template" id="tmpl-e-course-item-settings-lp_lesson">
  <div class="e-item-settings-extra">
            <ul class="e-form-field-table flex omar2">
        ...
        <div class="e-quiz-editor">
            ...
            <ul class="e-questions e-sortable" v-if="!hidden">
                ...
                <e-question-loop v-for="(question, index) in questions" :question="question" :item-data="itemData"
                                 ...
                                 @clone-question="_onCloneQuestion"
                ...
                <e-question-loop
                        ...
                        @press-question-title="_onKeydownQuestionTitle"
                        @press-question-add-btn="_onQuestionAddBtnClick"></e-question-loop>
            </ul>
    ...
    <script type="text/x-template" id="tmpl-e-question-loop">
        <li :class="questionClass()" :data-id="question.id" v-if="!hidden">
            ...
            <div class="e-item-input">
                <input type="text" v-model="question.title" @keydown="_onKeydown" class="question-loop-title" ref="questionTitle" :placeholder="'<?php esc_html_e( 'Question name', 'learnpress-frontend-editor' ); ?>'" @blur="_onBlur">
            </div>
            ...
            <div class="item-title-add-question-item">
                <button type="button" class="e-button item-question-add-btn disabled" @click="_addNewQuestionChild"><i class="fa fa-2x fa-plus-circle"></i></button>
            </div>
            <div class="e-item-actions question-actions e-sortable-actions">
                <span @click="edit" class="e-item-action more-action"></span>
                <span @click="_duplicate_question($event, question.id)" class="e-item-action duplicate-question-frontend"><i class="fa fa-copy"></i></span>
                <span @click="_delete($event, question.id)" class="e-item-action delete e-hold-down" @mousedown="_startAnim" @mouseup="_stopAnim"></span>
            </div>
            ...
            <ul class="e-form-field-table 09">
                ...
                <li class="e-form-field">
                    ...
                    <template v-else>
                        ...
                        <div class="e-form-field-input">
                            <div class="e-list-questions-heading">
                                <div class="e-list-questions-heading-frontend question-answer-text"># Answer Text</div>
                                <div class="e-list-questions-heading-frontend question-correct-text">Correct?</div>
                            </div>
