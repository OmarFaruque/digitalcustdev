        ...
        <h4 class="e-section-head">
            ...
            <div class="e-section-title">
                <input type="text" v-model="section.title" data-context="section-title" class="section-title"
                       ...
                       @onBlurItem="_onFocusOut($event)"
                       ref="sectionTitle"
                       placeholder="<?php _e( 'Section name', 'learnpress-frontend-editor' ); ?>">
            </div>
            <div class="e-section-add-btn">
                <button type="button" class="e-button item-section-add-btn disabled" @click="_addingNewSecton"><i class="fa fa-2x fa-plus-circle"></i></button>
            </div>
        </h4>
    </li>
</script>
    ...
    <li :class="sectionClasses()" tabindex="0" @focus="onFocus" @click="onFocus" @blur="onBlur"
        ...
        <h4 class="e-section-head">
            ...
            <div class="e-sortable-actions e-section-actions">
                <span class="duplicate-link" @click="_cloneSection($event, section)" @mousedown="_startAnim" @mouseup="_stopAnim" title="<?php esc_attr_e( 'Clone this item', 'learnpress-frontend-editor' ); ?>"><i class="fa fa-copy"></i></span>
