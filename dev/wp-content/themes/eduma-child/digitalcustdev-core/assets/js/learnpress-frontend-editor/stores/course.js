...
;(function ($) {
    ...
    Store.Actions = {
        ...
        updateSection: function (context, data) {
            return new Promise(function (resolve, reject) {
                FE_Helpers.Course_Editor_Request('', 'update-section', FE_Helpers.omitObjects(data)).then(function (r) {
                    if (r.section_course_id !== "") {
                        localStorage.setItem("digitalcustdev_addedSectionID", r.section_course_id);
                    }
        ...
        deleteItem: function (context, args) {
            ...
            FE_Helpers.Course_Editor_Request('', 'delete-course-item', {
        ...
        cloneItem: function (context, args) {
            return new Promise(function (resolve, reject) {
                FE_Helpers.Course_Editor_Request('', 'clone-course-item', {
                    section_ID: args.section_ID,
                    item: args.item,
                    position: args.position,
                    __activity: true
