        ...
        methods: {
            ...
            _onKeyPress: function (e) {
                ...
                if (e.keyCode == 13) {
                    ...
                    $('.item-section-add-btn').addClass('disabled');
                }
            },

            _addingNewSecton: function (e) {
                var $vm = this;
                e.preventDefault();
    ...
    Vue.component('e-course-section', {
        ...
        methods: $.extend({
            ...
            cloneItem: function ($ref, item) {
                ...
                $.each(this.section.items, function (i, r) {
                    if (parseInt(r.id) === parseInt(itemData.item_id)) {
                        itemData.content = r.content;
                        itemData.settings = r.settings;
                    }
                });
            ...
            _cloneSection: function (e, section) {
                ...
                if (typeof section.course_id === "undefined") {
                    ...
                    localStorage.removeItem('digitalcustdev_addedSectionID');
                }
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    data: {
                        action: 'lp_duplicate_main_section',
                        section: section
                    }
                    ...
                    if (response.status === 200) {
                        ...
                        if (window.location.hash !== "step-two") {
                            window.location.href = window.location.href + '#step-two';
                            localStorage.setItem("digitalcustdev_step", '2');
                        }
