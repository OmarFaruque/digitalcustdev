...
if ( $type == 'single' ) {
	...
	<div class="beauty" style="position: relative;">
		<div class="video-container content-asset">
			...
			if ( $src_poster ) { ?>
				<div class="btns">
					<div class="btn-player"><i class="fa fa-play-circle omar7"></i></div>
		...
		<ul class="slides">
			...
			<li data-thumb="<?php echo $arr_img[$j] ?>">
				<div class="content">
					...
					<!--						<source src="https://educationwp.thimpress.com/wp-content/uploads/2015/12/Eduma-learnling.mp4" type="video/mp4">-->
					<!--					</video>-->
